                                        ...
                                        <tr x-data class="border-t border-border-default transition-colors cursor-pointer {{ $hasPendingOffer ? 'bg-accent-red/10' : 'hover:bg-[rgba(59,130,246,0.05)]' }}"
                                            ...
                                            <td class="py-2.5 pl-2 pr-3">
                                                <div class="flex items-center gap-1.5">
                                                    ...
                                                    @endif
                                                    @if($hasStatureGap)
                                                        <svg x-data="" x-tooltip.raw="{{ __('transfers.player_wont_renew') }}" class="w-3.5 h-3.5 shrink-0 cursor-help text-accent-red" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
                                                        </svg>
                                                    @elseif($hasWageGap)
                                                        <svg x-data="" x-tooltip.raw="{{ __('transfers.player_wants_raise') }}" class="w-3.5 h-3.5 shrink-0 cursor-help text-accent-gold" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
                                                        </svg>
                                                    @endif
                                                </div>
