...
>
    ...
    <div class="flex h-full sm:min-h-full items-stretch sm:items-center justify-center p-0 sm:p-4">
        ...
        >
            ...
            {{-- Error banner --}}
            <div x-show="tacticalError"
                 x-transition:enter="ease-out duration-200"
                 x-transition:enter-start="opacity-0 -translate-y-1"
                 x-transition:enter-end="opacity-100 translate-y-0"
                 class="border-t border-accent-red/20 bg-accent-red/10 px-4 py-3 sm:px-6 shrink-0"
            >
                <div class="flex items-center gap-2.5">
                    <svg class="w-4 h-4 text-accent-red shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
                    </svg>
                    <p class="text-sm font-medium text-accent-red" x-text="tacticalError"></p>
                    <button type="button" @click="tacticalError = null" class="ml-auto text-accent-red/60 hover:text-accent-red shrink-0">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                        </svg>
                    </button>
