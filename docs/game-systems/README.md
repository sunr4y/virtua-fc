...
High-level documentation of the game systems that power VirtuaFC. These documents describe **what each system does and how it connects to others** — not exact formulas or configuration values. For specifics, follow the code references in each document.
