...
return [
    ...
    'style_tip_possession' => 'Fewer goals conceded and less energy drain, but slightly fewer chances created.',
    'style_tip_balanced' => 'No modifiers. Neutral style.',
    'style_tip_counter_attack' => 'Solid defensively with quick breaks, but higher energy drain.',
    'style_tip_direct' => 'More open game with goals at both ends. Slightly more tiring.',
    'style_summary_possession' => 'Control the ball to deny opponent chances. Saves energy but can be sterile.',
    'style_summary_balanced' => 'Balanced play with no bonuses.',
    'style_summary_counter_attack' => 'Sit back and strike on the break. Solid but physically demanding.',
    'style_summary_direct' => 'Long balls and quick transitions. More open game, slightly more tiring.',

    // Pressing Intensity
    'pressing_high_press' => 'High Press',
    'pressing_standard' => 'Standard',
    'pressing_low_block' => 'Low Block',
    'pressing_tip_high_press' => 'Creates chances from turnovers and reduces opponent goals, but fades after minute 55. Very tiring.',
    'pressing_tip_standard' => 'No modifiers. Balanced pressing.',
    'pressing_tip_low_block' => 'Fewer goals for you, but also fewer for opponent. Very light on energy.',
    'pressing_summary_high_press' => 'Press high to force turnovers. Creates chances early but fades after minute 55.',
    'pressing_summary_standard' => 'Balanced pressing with no bonuses.',
    'pressing_summary_low_block' => 'Defend deep. Fewer chances to score but solid defensively. Saves the most energy.',
