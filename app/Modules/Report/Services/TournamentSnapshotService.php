    ...
    private function serializeSummaryData(array $data, array $teams, Game $game): array
    {
        ...
        foreach ($data['knockoutTies'] as $roundNumber => $ties) {
            ...
            $knockoutTies[$roundNumber] = [
                ...
                'ties' => $ties->map(fn ($tie) => [
                    ...
                    'home_score_et' => $tie->firstLegMatch?->home_score_et,
                    'away_score_et' => $tie->firstLegMatch?->away_score_et,
        ...
        if ($data['finalMatch']) {
            ...
            $finalMatch = [
                ...
                'home_score_et' => $fm->home_score_et,
                'away_score_et' => $fm->away_score_et,
